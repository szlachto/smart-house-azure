...
public class ReadEntity {
	...
	public List<FoggerEntity> readJsonStream(InputStream in) throws IOException {
	...
	public List<FoggerEntity> readEntityArray(JsonReader reader) throws IOException {
		List<FoggerEntity> foggerEntity = new ArrayList<FoggerEntity>();
	...
	public FoggerEntity readEntity(JsonReader reader) throws IOException {
		String entity = null;
		...
		reader.endObject();
		return new FoggerEntity(entity, fields, tags);
	}

	public FoggerData readFoggerData(JsonReader reader) throws IOException {
	...
	public Tags readTags(JsonReader reader) throws IOException {
	...
	public Measurements readMeasurements(JsonReader reader) throws IOException {
	...
	public CmpVal readCmpVal(JsonReader reader) throws IOException {
		float v = -1f;
		int q = -1;
	...
	public String serialize(List<FoggerEntity> foggerEntityList) {
		Gson gson = new Gson();
